...
The purpose of the relational model is to have an abstraction of the database from the physical layer. This abstraction is known as the logical layer. This abstraction allows database administrators to manage the physical storage without affecting the access to th 
