...
To do this, students are taught the iterative-incremental software process model, and are expected to use it in their work \cite{SoftwareProcessModels}. The teams have common means of collaboration (see Section \ref{communication_in_knox})
