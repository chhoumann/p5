...
One of the main goals with establishing committees that overlooked most of the main parts of the \knox{} project was to get ahead of potential future problems that could arise with multiple teams working on the same project. 
This was done by escalating decisions that would have a large affect on the development teams to these committees and allowing them to take a decisions with the input from all other teams. 
The wanted outcome from this was to make the planning phase easier for the groups due to them knowing when other teams expected to develop and release components they relied on.
