...
We had received three user stories from the PO, and could use them to plan the next sprint.
...
We learned that it is easier to keep an overview in smaller scale sprints, as the resulting granulation of tasks is easier to do. 
In previous sprints, when issues or new tasks were identified by the PO of the group, we had more plans to change to accommodate new demands. With the smaller sprints, changes to the plan are easier to handle. 
