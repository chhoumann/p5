...
\vspace*{\fill}
  ...
  {\color{white}\fboxsep0pt\colorbox{aaublue}{\begin{tabular}{@{}p{\textwidth}@{}}
    \begin{center}
    \Huge{\textbf{
      Knox Database% insert your title here
    }}
    \end{center}
    \begin{center}
      \Large{
        Knox: Server and database management % insert your subtitle here
      }
    \end{center}
    \vspace{0.2cm}
   \begin{center}
    ...
    \vspace{0.2cm}
    {\large
      Software Engineering, cs-21-sw-5-19, 2021-12% insert name of study, group number, year-month
    }
   \end{center}
   \vspace{0.2cm}
