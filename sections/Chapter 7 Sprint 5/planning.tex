...
Our own product owner, along with the second and fourth layer, granulated these user stories as we consider them to be \textit{epics} \cite{Epics}.
...
\userStory{the knowledge layer}{to be able to insert Triples into a storage}{others can access it later}
