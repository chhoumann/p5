...
As the second and fourth layer are the two layers that are immediately dependent on our layer our own product owner, along with the second and fourth layer, granulated these user stories as we consider them to be \textit{epics} \cite{Epics}.
