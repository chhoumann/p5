...
As an example, we produce a relation containing all books with the title "Database System Concepts":\\
...
For instance, we can concatinate the information in the $book\_owner$ and $owns$  relations.
...
Thus we can express the relation describing the name of all $book\_owner$ entities, that owns thew book with $ISBN$ "987-1-...50-4" as both equation \ref{eq:join_s} and equation \ref{eq:join_j}.
