...
Some of the common operators of in relational algebra can be seen in table \ref{Relational algebra operators}.
...
In relational algebra, an equivalent opertation could be described as $\pi_{title}\sigma_{owns.owner\_id = 10}(owns \Join_{book.isbn = book.isbn} book )$.
