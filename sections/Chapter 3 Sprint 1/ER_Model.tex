...
Therefore, it is useful to be able to convert an ER model into an equivalent relational model, where domains of attributes can be well defined and operations on the entity sets described mathematically.
