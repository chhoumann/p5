...
Figure \ref{fig:ER_Book_Example} shows an ER diagram equivalent to the $book$, $owns$, and $book\_owner$ relations from equation \ref{eq:bookOwnerExample} and \ref{eq:relational_schema}.
