...
The attribute associated with the entity sets can be modelled using ovals \cite{KatjaFirstPP}, however other alternatives exists \footnotetext{Our style of choice is presented in Chapter 6.10 of \cite{DBSBook}}
...
This relationship does not have full participation. Participation connections can be seen on figure \ref{fig:ERDiagram_Cardinality}.
