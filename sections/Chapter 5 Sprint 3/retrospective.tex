...
As such, we did not hit our original point-estimate, which became completely irrelevant due to the rapid changes in scope.
...
This was especially true when working on the APIs where we initially thought that we had to develop full CRUD capabilities, but it turned out that only some of the capabilities were necessary. 
