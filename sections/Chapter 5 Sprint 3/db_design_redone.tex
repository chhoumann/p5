...
Currently, we just store every single word in the database without regard for duplicates, which takes up way more space than necessary. Thus it is not of the third normal form, and thus not in BCNF either.
