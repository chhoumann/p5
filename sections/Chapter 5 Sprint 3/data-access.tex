...
EF Core works by using models to create the data access, where models represent the entities in a database, and a context object represents a session with the given database. 
