...
The requirements that fulfill our part of the \knox{} goal, for this sprint, were realized during the second sprint, and as such, the tasks related to this sprint were only related to implementing what we did not have time to do. The only addition during the planning phase of this sprint was an ambition to implement a repository service and CI/CD. To estimate the time to complete these tasks, a session of planning poker was held. The tasks and their time estimate can be seen in table \ref{BacklogEstimationSprint3}.
\begin{table}[h]
\centering
