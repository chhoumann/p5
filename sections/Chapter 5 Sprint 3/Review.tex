...
For this sprint, the primary focus was been to implement the Knox Search Engine. As such, all other groups had the same focus, and therefore they did not requested anything from the database layer yet. 
