...
Towards the end of this sprint, we demonstrated an end-to-end test to the \knox{} product owner. The pipeline seemed to work well, and we were able to get the product to work as expected. This was later confirmed by the PO. Right after the sprint, another test was performed, and the WordCount APIs crashed under heavy load. We pushed a hotfix to this shortly after.
