...
\begin{equation}\label{create_new_view_rel_alg_structure}
    ...
    \end{split}
\end{equation}
Having established the new structures for the database using the relational model and relational algebra, we can develop a corresponding the ER model to document the design. 
