...
In sprint 5, section \ref{sec:userstories5}, we mention receiving user stories about implementing a RDF database, such that other \knox{} layers could use it to facilitate a knowledge graph.
